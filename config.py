...
class Config:
    def __init__(self, model_name= 'ViTForClassification'):
        ...
        if self.model_name == "ViTForClassification_V2":
            ...
            self.num_hidden_layers= 3 #3
            self.num_attention_heads= 8 #8
            self.intermediate_size= 3*216 # 3 * 216 # 3 * hidden_size
            self.hidden_dropout_prob= 0.25 # 0.25
            self.attention_probs_dropout_prob= 0.25 #0.25
            self.initializer_range= 0.02
